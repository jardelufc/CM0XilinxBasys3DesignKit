...
//-----------------------------------------------------------------------------
Vector_Table:    
    .word  0x00000C00                   // Top of stack (same as kernel stack)
...
scheduler:
    ...
    ldr r0, =0x00000800             // r0 = ram_start
...
//    ldr r0, =0x20000000         // r0 = start of RAM and also kernel memory
    ldr r0, =0x00000800         // r0 = start of RAM and also kernel memory
    ...
    ldr r1,=1000              // 48000 = 1ms based on the fact that PLL will 
...
//    ldr r1,=0x20000000          // for r4-r11 and 32 for usual layout)
    ldr r1,=0x00000800          // for r4-r11 and 32 for usual layout)   
...
init_loop:
    ...
    ldr r4,=0x00001000          // top of memory   
